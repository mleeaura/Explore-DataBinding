...
public class ButtonHandler {
    ...
    /**
     * Add a user to the random  pos of the list.
     */
    public void addRandom() {
        ...
        int ranPos = new Random().nextInt(size);
        users.add(ranPos, randomUser());
    }

    /**
     * Re-arrange item pos of the list.
     */
    public void useReArrange() {
        int size = users.size();
        ...
        int ranPickPos = new Random().nextInt(size);
        int ranChPos = new Random().nextInt(size);
        if (ranPickPos == ranChPos) return;

        User remove = users.remove(ranPickPos);
        users.add(ranChPos, remove);
    }
